...
def get_account(
    ...
    """
    Summary:
    get_account finds the main account row for the company name provided by
    the user. It uses schema.py to find the correct accounts table and name
    column before running the account lookup query.

    @param connection: the DuckDB database connection
    @param schema: the inspected database schema
    @param account_name: the account or company name to search for

    @return: the matching account row, or None if no account is found
    """
...
def get_opportunities(
    ...
    @param connection: the DuckDB database connection
    @param schema: the inspected database schema
    @param account: the resolved account row

    @return: a list of opportunity rows connected to the account
    """
...
def get_calls(
    ...
    @return: a list of call rows connected to the account
    """
...
def get_funnel_activity(
    ...
    @return: a list of funnel activity rows connected to the account
    """
...
def get_product_usage(
    ...
    @return: a list of product usage rows connected to the account
    """
...
def build_account_context(
    ...
    @param connection: the DuckDB database connection
    @param schema: the inspected database schema
    @param account_name: the account or company name to build context for

    @return: a dictionary containing the account row and related GTM context
    """
